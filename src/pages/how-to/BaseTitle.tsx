  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto">
        ...
        {/* initial and baseTitle.id relationship */}
        <div className="mb-12">
          <h2
            className="text-base font-semibold mb-3"
            style={{color: 'var(--primary-text-color)'}}
          ...
          >
            ...
            renders first. <code>baseTitle.id</code> owns the title — it anchors
            the navigation reference to that same level. Both must be the same
            string.
          </p>
        ...
        <div className="mb-12">
          ...
          >
            ...
            itself. It surfaces once you navigate away — as the back-navigation
            label in the header and as the root anchor in the breadcrumb
            dropdown.
          </p>
        ...
        <div className="mb-12">
          ...
          >
            <p
              ...
              style={{color: 'var(--secondary-text-color)'}}
            >
              The component has no knowledge of your data, so <code>title</code>{' '}
              is left entirely to you. Set it to whatever "home" means in your
              context.
            </p>
          ...
          >
            ...
            <div className="px-4 py-4">
              <p
                ...
                style={{color: 'var(--secondary-text-color)'}}
              >
                When <code>baseTitle.id</code> and <code>initial</code> point to
                different levels the navigation reference breaks — the back
