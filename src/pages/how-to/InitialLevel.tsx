      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-16">
          ...
          >
            ...
            the drilldown first mounts. It accepts a string that must match one
            of your <code>items</code> keys and follow the{' '}
        ...
        <div className="mb-16">
          <h2
            ...
            style={{color: 'var(--primary-text-color)'}}
          >
            The <code className="text-xl">LEVEL_&#123;number&#125;</code> Naming
            Rule
          </h2>
